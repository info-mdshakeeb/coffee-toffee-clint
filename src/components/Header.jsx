...
import one from "../assets/images/a1.png";
import three from "../assets/images/a3.png";
import Navbar from "./navbar/Navbar";
const Header = () => {
    return (
        <div className="max-w-6xl mx-auto  shadow-xl  bg-white rounded-2xl">
            ...
            <div className="lg:flex items-center ">
                <div className="lg:w-1/2">
                    <div className="">
                        ...
                        <div className="font-[700] font-2xl flex flex-col gap-10 mt-10 ">
                ...
                <div className="lg:w-1/2">
                    <img className=" w-full object-scale-down" src={headerImg} alt="" />
                </div>

            </div>

            <div className="hidden md:flex justify-around lg:max-w-4xl">
